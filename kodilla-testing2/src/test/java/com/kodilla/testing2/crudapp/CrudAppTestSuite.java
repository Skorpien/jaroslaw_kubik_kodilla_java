...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://skorpien.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("jkubik87@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("2cQqX4qvXFMA&zE");
